...
public:
	...
	*/
	...
	static int evaluate_cols(unsigned long long bitBoard);
	static int evaluate_rows(unsigned long long row);
	static int evaluate_diag1(unsigned long long bitBoard);
	static int evaluate_diag2(unsigned long long bitBoard);
	static int evaluate(X_O_5x5_BoardData board);
	static int evaluate(unsigned long long bitBoard);
	static int evaluate_row(unsigned long long row, int offset);
